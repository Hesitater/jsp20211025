...
<title>20map-bean.jsp</title>
</head>
<body>

<%
Map<String, Bean03> map = new HashMap<String, Bean03>();
...
<p>1번 나이 : ${persons.person1.name}</p>
<p>1번 이름 : ${persons.person1.age }</p>

<p>2번 나이 : ${persons.person2.name }</p>
<p>2번 이름 : ${persons.person2.age }</p>
